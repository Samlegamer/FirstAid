        ...
        if (entity instanceof Player) {
            ...
            if (renderDispatcher.shouldRenderHitBoxes()) {
                ...
                if (entity.isCrouching()) {
                    event.getPoseStack().translate(0D, 0.125D, 0D);
                }
                ...
                for (AABBAlignedBoundingBox box : allBoxes) {
                    ...
                    LevelRenderer.renderLineBox(event.getPoseStack(), event.getMultiBufferSource().getBuffer(RenderType.lines()), bbox.inflate(0.02D).move(-entity.getX(), -entity.getY(), -entity.getZ()), r, g, b, 1.0F);
                    r += 0.25F;
                    g += 0.5F;
                    b += 0.1F;
